...
let abc1 = document.querySelector("#skil");
let abc2 = document.querySelector("#intern_train");
let abc3 = document.querySelector("#prjct");
let abc4 = document.querySelector("#por1");
let abc5 = document.querySelector("#haa");
let abc6 = document.querySelector("#lii");

skill_button.addEventListener(
  "click",
  (funct = () => {
...
intern_button.addEventListener(
  "click",
  (funct = () => {
...
respon_button.addEventListener(
  "click",
  (funct = () => {
...
generate.addEventListener("click", () => {
  let h1 = 0;
  document.querySelector(".isnt").innerHTML = markuptext2(
    markuptext(document.querySelector(".institute").value, "*", "strong"),
    "_",
    "em"
  );
  document.querySelector(".perc").innerHTML = markuptext2(
    markuptext(document.querySelector("#prcntge").value, "*", "strong"),
    "_",
    "em"
  );
  document.querySelector(".yr").innerHTML = markuptext2(
    markuptext(document.querySelector("#yE").value, "*", "strong"),
    "_",
    "em"
  );

  document.querySelector(".cfirst").innerHTML = markuptext2(
    markuptext(document.querySelector(".c1").value, "*", "strong"),
    "_",
    "em"
  );
  document.querySelector(".c11").innerHTML = markuptext2(
    markuptext(document.querySelector(".c2").value, "*", "strong"),
    "_",
    "em"
  );
  document.querySelector(".c12").innerHTML = markuptext2(
    markuptext(document.querySelector(".c3").value, "*", "strong"),
    "_",
    "em"
  );
  document.querySelector(".c13").innerHTML = markuptext2(
    markuptext(document.querySelector(".c4").value, "*", "strong"),
    "_",
    "em"
  );
  document.querySelector(".c14").innerHTML = markuptext2(
    markuptext(document.querySelector(".c5").value, "*", "strong"),
    "_",
    "em"
  );
  document.querySelector(".c15").innerHTML = markuptext2(
    markuptext(document.querySelector(".c6").value, "*", "strong"),
    "_",
    "em"
  );
  document.querySelector(".c16").innerHTML = markuptext2(
    markuptext(document.querySelector(".c7").value, "*", "strong"),
    "_",
    "em"
  );
  document.querySelector(".c17").innerHTML = markuptext2(
    markuptext(document.querySelector(".c8").value, "*", "strong"),
    "_",
    "em"
  );

  document.querySelector(".c22").innerHTML = markuptext2(
    markuptext(document.querySelector(".c1").value, "*", "strong"),
    "_",
    "em"
  );
  document.querySelector(".c23").innerHTML = markuptext2(
    markuptext(document.querySelector(".c2").value, "*", "strong"),
    "_",
    "em"
  );
  document.querySelector(".c24").innerHTML = markuptext2(
    markuptext(document.querySelector(".c3").value, "*", "strong"),
    "_",
    "em"
  );
  document.querySelector(".c25").innerHTML = markuptext2(
    markuptext(document.querySelector(".c4").value, "*", "strong"),
    "_",
    "em"
  );
  document.querySelector(".c26").innerHTML = markuptext2(
    markuptext(document.querySelector(".c5").value, "*", "strong"),
    "_",
    "em"
  );
  document.querySelector(".c27").innerHTML = markuptext2(
    markuptext(document.querySelector(".c6").value, "*", "strong"),
    "_",
    "em"
  );
  document.querySelector(".c28").innerHTML = markuptext2(
    markuptext(document.querySelector(".c7").value, "*", "strong"),
    "_",
    "em"
  );
  document.querySelector(".c29").innerHTML = markuptext2(
    markuptext(document.querySelector(".c8").value, "*", "strong"),
    "_",
    "em"
  );
  document.querySelector(".c30").innerHTML = markuptext2(
    markuptext(document.querySelector(".c9").value, "*", "strong"),
    "_",
    "em"
  );
  document.querySelector(".c31").innerHTML = markuptext2(
    markuptext(document.querySelector(".c10").value, "*", "strong"),
    "_",
    "em"
  );
  ...
  requestAnimationFrame(() => {
    h1 = h1 + document.querySelector(".acd").offsetHeight;
    console.log(h1);
  });

  document.querySelector("#names_").innerHTML =
  ...
  for (let e of skillst) {
    if (e.value != "") st6 += `<li> ${e.value} </li>`;
  }

  if (st6 == "") {
    document.querySelector(".skl").setAttribute("style", "display:none;");
    document.querySelector("#skil").remove();
  } else {
    ...
    requestAnimationFrame(() => {
      h1 = h1 + document.querySelector(".skl").offsetHeight;
      console.log(h1);
      if (h1 < 901) {
        document.querySelector("#skil").remove();
      } else {
  ...
  for (let j = 0; j < k; j++) {
    string1 +=
      `<li style="display:flex;justify-content:space-between;list-style:none;background:#e3e3e3;;padding:2px;margin-bottom:4px; margin-top:8px">` +
      `<h6 style="font-weight:700;margin-left:1rem;">` +
      st[j] +
      `</h6>`;

    string1 +=
      `<div>` + `<h7 style="margin-right:2rem;">` + str1[j] + "&nbsp" + "-";
  ...
  if (string1 == "") {
    ...
    document.querySelector("#intern_train").remove();
  } else {
    ...
    requestAnimationFrame(() => {
      h1 = h1 + document.querySelector(".int1").offsetHeight;
      console.log(h1);
      if (h1 < 901) {
        document.querySelector("#intern_train").remove();
      } else h1 = 0;
  ...
  for (let j = 0; j < a; j++) {
    strings +=
      `<li style="display:flex;justify-content:space-between;list-style:none;background:#e3e3e3;padding:2px;margin-bottom:4px;margin-top:8px;margin-left: -32px;">` +
      `<h6 style="font-weight:700;margin-left:1rem;">` +
      stt[j] +
      `</h6>`;
  ...
  if (strings == "") {
    ...
    document.querySelector("#prjct").remove();
  } else {
    document
    ...
    requestAnimationFrame(() => {
      h1 = h1 + document.querySelector(".projects").offsetHeight;
      console.log(h1);
      if (h1 < 901) {
        document.querySelector("#prjct").remove();
      } else h1 = 0;
  ...
  for (let j = 0; j < k; j++) {
    string1 +=
      `<li style="display:flex;justify-content:space-between;list-style:none;background:#e3e3e3;;padding:2px;margin-bottom:4px;">` +
      `<h6 style="font-weight:700;margin-left:1rem;">` +
      st[j] +
      `</h6>`;
  ...
  if (string1 == "") {
    ...
    document.querySelector("#por1").remove();
  } else {
    ...
    requestAnimationFrame(() => {
      h1 = h1 + document.querySelector(".por").offsetHeight;
      console.log(h1);
      if (h1 < 901) {
        document.querySelector("#por1").remove();
        console.log("abs");
  ...
  document.getElementById("gitT").innerHTML =
    document.getElementById("Inputgit").value;
  ...
  requestAnimationFrame(() => {
    h1 = h1 + document.querySelector(".lnk").offsetHeight;
    console.log(h1);
    if (h1 < 901) {
      document.querySelector("#lii").remove();
      console.log("abs");
    } else {
      h1 = 0;
    }
  ...
  document.querySelector("#deg1").innerHTML = markuptext2(
    markuptext(document.querySelector("#inputboard1").value, "*", "strong"),
    "_",
    "em"
  );
  document.querySelector("#in1").innerHTML = markuptext2(
    markuptext(document.querySelector("#inputyear1").value, "*", "strong"),
    "_",
    "em"
  );
  document.querySelector("#r1").innerHTML = markuptext2(
    markuptext(document.querySelector("#inpupercentage1").value, "*", "strong"),
    "_",
    "em"
  );
  document.querySelector("#y1").innerHTML = markuptext2(
    markuptext(document.querySelector("#inpupass1").value, "*", "strong"),
    "_",
    "em"
  );
  document.querySelector("#deg").innerHTML = markuptext2(
    markuptext(document.querySelector("#inputborad").value, "*", "strong"),
    "_",
    "em"
  );
  document.querySelector("#inn").innerHTML = markuptext2(
    markuptext(document.querySelector("#inpuyear").value, "*", "strong"),
    "_",
    "em"
  );
  document.querySelector("#r").innerHTML = markuptext2(
    markuptext(document.querySelector("#inpupercentage").value, "*", "strong"),
    "_",
    "em"
  );
  document.querySelector("#yre").innerHTML = markuptext2(
    markuptext(document.querySelector("#inpupass").value, "*", "strong"),
    "_",
    "em"
  );
...
lastest.addEventListener("click", () => {
  ...
  let xyz1 = document.querySelector(".skl");
  let xyz2 = document.querySelector(".int1");
  let xyz3 = document.querySelector(".projects");
  let xyz4 = document.querySelector(".por");
  let xyz5 = document.querySelector(".honours");
  let xyz6 = document.querySelector(".lnk");
  let pqrs = document.querySelector("#main");
  xyz1.parentNode.insertBefore(abc1, xyz1);
  xyz2.parentNode.insertBefore(abc2, xyz2);
  xyz3.parentNode.insertBefore(abc3, xyz3);
  xyz4.parentNode.insertBefore(abc4, xyz4);
  xyz5.parentNode.insertBefore(abc5, xyz5);
  xyz6.parentNode.insertBefore(abc6, xyz6);
});
