...
in_button.addEventListener("click",()=>{
    ...
    newinput.setAttribute("placeholder","Enter Your Comapany");
    newinput.classList.add("mt-2");
    let msg=document.createElement("button");
    msg.classList.add("form-text");
    msg.classList.add("button-sub");
     ...
     let newwork=document.createElement("input");
     newwork.classList.add("form-work");
     newwork.classList.add("work-interns");
     newwork.setAttribute("placeholder","elaborate your work");
     newwork.classList.add("mt-2");
     let ms=document.createElement("button");
     ms.classList.add("form-text");
     ms.classList.add("button-sub");
      ms.innerText="-";
    ...
    after.insertBefore(newinput,before);
    after.insertBefore(newwork,before);
    after.insertBefore(date,before);
    after.insertBefore(msg,before);
    after.insertBefore(ms,before);
